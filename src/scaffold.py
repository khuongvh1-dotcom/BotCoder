...
- Do not run destructive shell commands (no mass delete, no network exfiltration).

## Quality
- Add or update tests when the task asks for them; make the project's test command pass.
